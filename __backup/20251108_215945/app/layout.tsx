...
export default function RootLayout({ children }:{children:React.ReactNode}){
  return (
    ...
    dangerouslySetInnerHTML={{ __html: "(function(){document.addEventListener('click',function(e){var list=document.querySelectorAll('details[open]');for(var i=0;i<list.length;i++){var d=list[i];if(!d.contains(e.target)) d.removeAttribute('open');}},true);})();" }}
