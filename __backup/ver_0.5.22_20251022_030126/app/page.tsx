...
<section data-home-update-version="0.5.21" style={{ border:"1px solid var(--border,#E5E7EB)", borderRadius:8, padding:12, margin:"12px 0", background:"var(--background,#FFFFFF)", color:"var(--foreground,#111827)" }}>
  <h2 style={{ margin:0, marginBottom:6, fontSize:14 }}>更新履歴 v0.5.21（2025-10-22）</h2>
  <ul style={{ margin:0, paddingLeft:18, fontSize:13, lineHeight:1.5 }}>
    <li>ユーザー用ビルダー：4枠を指定順に整備（読み込み／フォームカラー設定（フォームに反映）／対象外(非適用)設定／建物フォルダ作成とURL発行）。</li>
    <li>ビルダー内ヘッダー：モバイル小さめ＋右ハンバーガーで各枠リンク。</li>
    <li>配色は globals.css のトークン準拠（直値は避ける）。</li>
    <li>バックアップ：__backup\ver_0.5.21\* に保存。</li>
  </ul>
</section>
