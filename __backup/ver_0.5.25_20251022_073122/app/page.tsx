...
<section data-home-update-version="0.5.24" style={{ border:"1px solid var(--border,#E5E7EB)", borderRadius:8, padding:12, margin:"12px 0", background:"var(--background,#FFFFFF)", color:"var(--foreground,#111827)" }}>
  <h2 style={{ margin:0, marginBottom:6, fontSize:14 }}>更新履歴 v0.5.24（2025-10-22）</h2>
  <ul style={{ margin:0, paddingLeft:18, fontSize:13, lineHeight:1.5 }}>
    <li>ヘッダー：右ハンバーガー化、左タイトルはモバイル小さめ。</li>
    <li>ユーザー用ビルダー：4枠に統一（読み込み／フォームカラー設定（フォームに反映）／対象外(非適用)設定／建物フォルダ作成とURL発行）。</li>
    <li>既存 UI を流用。配色は globals.css のトークンに追随。</li>
    <li>バックアップ：__backup\ver_0.5.24\*</li>
  </ul>
</section>
