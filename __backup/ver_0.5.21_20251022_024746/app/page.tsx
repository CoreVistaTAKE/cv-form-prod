...
<section data-home-update-version="0.5.19" style={{ border:"1px solid var(--border,#E5E7EB)", borderRadius:8, padding:12, margin:"12px 0", background:"var(--background,#FFFFFF)", color:"var(--foreground,#111827)" }}>
  <h2 style={{ margin:0, marginBottom:6, fontSize:14 }}>更新履歴 v0.5.19（2025-10-22）</h2>
  <ul style={{ margin:0, paddingLeft:18, fontSize:13, lineHeight:1.5 }}>
    ...
    <li>バックアップ：__backup\ver_0.5.19\*</li>
  </ul>
</section>
