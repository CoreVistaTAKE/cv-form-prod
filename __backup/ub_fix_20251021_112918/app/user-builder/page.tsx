...
export default function UserBuilderPage(){
  ...
  return (
    <div className="space-y-6">
      <div style={{ '--cv-border': 'var(--border, #E5E7EB)', '--cv-surface': 'var(--background, #FFFFFF)', '--cv-text': 'var(--foreground, #111827)', '--cv-muted': 'var(--muted-foreground, #6B7280)', '--cv-accent': 'var(--primary, #111827)', '--cv-disabled': 'var(--muted, #9CA3AF)', '--cv-track': 'var(--muted, #F3F4F6)', '--cv-danger-border': 'var(--destructive, #FCA5A5)', '--cv-danger-bg': 'var(--destructive, #FEF2F2)', '--cv-danger-text': 'var(--destructive-foreground, #991B1B)' }}>
        <BuildingFolderPanel />
      </div>'
